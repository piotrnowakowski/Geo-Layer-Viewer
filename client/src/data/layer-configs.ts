...
export const LAYER_GROUPS: LayerGroupDef[] = [
  ...
  { id: "buildings",          label: "Buildings",                section: "derived"        },
...
export const LAYER_CONFIGS: LayerConfig[] = [
  ...
  { id: "oef_copernicus_dem",   name: "DEM Elevation (Copernicus)",    icon: Mountain, color: "#a16207", source: "tiles",   group: "hydrology", available: false, tileLayerId: "copernicus_dem_visual", hasValueTiles: false },
  { id: "oef_merit_elv",        name: "Terrain Elevation (MERIT)",     icon: Mountain, color: "#bc6c25", source: "tiles",   group: "hydrology", available: false, tileLayerId: "merit_elv",            hasValueTiles: false },
  { id: "oef_merit_upa",        name: "Upstream Area (MERIT)",         icon: Droplets, color: "#0369a1", source: "tiles",   group: "hydrology", available: false, tileLayerId: "merit_upa",            hasValueTiles: false },
  { id: "oef_merit_hydro",      name: "Height Above Drainage (MERIT)", icon: Droplets, color: "#0ea5e9", source: "tiles",   group: "hydrology", available: false, tileLayerId: "merit_hydro_hand",     hasValueTiles: false },
  ...
  { id: "oef_jrc_occurrence",   name: "Surface Water Occurrence (JRC)",icon: Waves,    color: "#1d4ed8", source: "tiles",   group: "hydrology", available: false, tileLayerId: "jrc_occurrence",       hasValueTiles: false },
  { id: "oef_jrc_seasonality",  name: "Surface Water Seasonality (JRC)",icon:Waves,   color: "#0891b2", source: "tiles",   group: "hydrology", available: false, tileLayerId: "jrc_seasonality",      hasValueTiles: false },
  { id: "oef_jrc_surface_water",name: "Surface Water Change (JRC)",    icon: Waves,    color: "#0077b6", source: "tiles",   group: "hydrology", available: false, tileLayerId: "jrc_surface_water",    hasValueTiles: false },
  { id: "oef_hansen_treecover", name: "Tree Cover 2000 (Hansen)",      icon: Trees,    color: "#166534", source: "tiles",   group: "hydrology", available: false, tileLayerId: "hansen_treecover2000", hasValueTiles: false },
  { id: "oef_emsn194",          name: "2024 Flood Depth (Copernicus)", icon: CloudRain,color: "#1d4ed8", source: "tiles",   group: "hydrology", available: false, tileLayerId: "copernicus_emsn194",   hasValueTiles: false },
  ...
  // CHIRPS — all confirmed accessible value_tiles (V2_0 path, scale=100)
  {
    ...
    source: "tiles", group: "climate_extreme", available: false, tileLayerId: "chirps_r90p_2024",
    hasValueTiles: true,
  ...
  },
  {
    ...
    source: "tiles", group: "climate_extreme", available: false, tileLayerId: "chirps_r90p_clim",
    hasValueTiles: true,
  ...
  },
  {
    ...
    source: "tiles", group: "climate_extreme", available: false, tileLayerId: "chirps_r95p_2024",
    hasValueTiles: true,
  ...
  },
  {
    ...
    source: "tiles", group: "climate_extreme", available: false, tileLayerId: "chirps_r95p_clim",
    hasValueTiles: true,
  ...
  },
  {
    ...
    source: "tiles", group: "climate_extreme", available: false, tileLayerId: "chirps_r99p_2024",
    hasValueTiles: true,
  ...
  },
  {
    ...
    source: "tiles", group: "climate_extreme", available: false, tileLayerId: "chirps_r99p_clim",
    hasValueTiles: true,
  ...
  },
  {
    ...
    source: "tiles", group: "climate_extreme", available: false, tileLayerId: "chirps_rx1day_2024",
    hasValueTiles: true,
  ...
  },
  {
    ...
    source: "tiles", group: "climate_extreme", available: false, tileLayerId: "chirps_rx1day_clim",
    hasValueTiles: true,
  ...
  },
  {
    ...
    source: "tiles", group: "climate_extreme", available: false, tileLayerId: "chirps_rx5day_2024",
    hasValueTiles: true,
  ...
  },
  {
    ...
    source: "tiles", group: "climate_extreme", available: false, tileLayerId: "chirps_rx5day_clim",
    hasValueTiles: true,
  ...
  { id: "oef_era5_tnx_2024",   name: "Min Temp Max TNx 2024 (ERA5)",   icon: Thermometer, color: "#b45309", source: "tiles", group: "climate_extreme", available: false, tileLayerId: "era5_tnx_2024",  hasValueTiles: false },
  { id: "oef_era5_tnx_clim",   name: "Min Temp Max TNx Baseline",      icon: Thermometer, color: "#d97706", source: "tiles", group: "climate_extreme", available: false, tileLayerId: "era5_tnx_clim",  hasValueTiles: false },
  { id: "oef_era5_tx90p_2024", name: "Hot Days TX90p 2024 (ERA5)",     icon: Thermometer, color: "#c2410c", source: "tiles", group: "climate_extreme", available: false, tileLayerId: "era5_tx90p_2024",hasValueTiles: false },
  { id: "oef_era5_tx90p_clim", name: "Hot Days TX90p Baseline",        icon: Thermometer, color: "#ea580c", source: "tiles", group: "climate_extreme", available: false, tileLayerId: "era5_tx90p_clim",hasValueTiles: false },
  { id: "oef_era5_tx99p_2024", name: "Extreme Heat TX99p 2024 (ERA5)", icon: Thermometer, color: "#991b1b", source: "tiles", group: "climate_extreme", available: false, tileLayerId: "era5_tx99p_2024",hasValueTiles: false },
  { id: "oef_era5_tx99p_clim", name: "Extreme Heat TX99p Baseline",    icon: Thermometer, color: "#b91c1c", source: "tiles", group: "climate_extreme", available: false, tileLayerId: "era5_tx99p_clim",hasValueTiles: false },
  { id: "oef_era5_txx_2024",   name: "Max Temp TXx 2024 (ERA5)",       icon: Thermometer, color: "#7f1d1d", source: "tiles", group: "climate_extreme", available: false, tileLayerId: "era5_txx_2024",  hasValueTiles: false },
  { id: "oef_era5_txx_clim",   name: "Max Temp TXx Baseline",          icon: Thermometer, color: "#dc2626", source: "tiles", group: "climate_extreme", available: false, tileLayerId: "era5_txx_clim",  hasValueTiles: false },
  // HWM — 2024 + projections confirmed accessible; climatology 403
  {
    ...
    source: "tiles", group: "climate_extreme", available: false, tileLayerId: "hwm_2024",
    hasValueTiles: true,
  ...
  { id: "oef_hwm_clim", name: "Heatwave Magnitude Baseline", icon: Flame, color: "#f59e0b",
    source: "tiles", group: "climate_extreme", available: false, tileLayerId: "hwm_clim", hasValueTiles: false },
  ...
  // FRI — 2024 + multiple scenarios confirmed accessible
  {
    ...
    source: "tiles", group: "climate_projections", available: false, tileLayerId: "fri_2024",
    hasValueTiles: true,
  ...
  },
  {
    ...
    source: "tiles", group: "climate_projections", available: false, tileLayerId: "fri_2030s_245",
    hasValueTiles: true,
  ...
  { id: "oef_fri_2030s_585", name: "Flood Risk 2030s SSP5-8.5", icon: TrendingUp, color: "#1d4ed8",
    source: "tiles", group: "climate_projections", available: false, tileLayerId: "fri_2030s_585", hasValueTiles: false,
  ...
  { id: "oef_fri_2050s_245", name: "Flood Risk 2050s SSP2-4.5", icon: TrendingUp, color: "#2563eb",
    source: "tiles", group: "climate_projections", available: false, tileLayerId: "fri_2050s_245", hasValueTiles: false,
    valueEncoding: { type: "numeric", scale: 100, offset: 9, unit: "index 0–1" } },
  {
    ...
    source: "tiles", group: "climate_projections", available: false, tileLayerId: "fri_2050s_585",
    hasValueTiles: true,
  ...
  { id: "oef_fri_2100s_245", name: "Flood Risk 2100s SSP2-4.5", icon: TrendingUp, color: "#60a5fa",
    source: "tiles", group: "climate_projections", available: false, tileLayerId: "fri_2100s_245", hasValueTiles: false,
    valueEncoding: { type: "numeric", scale: 100, offset: 0, unit: "index 0–1" } },
  { id: "oef_fri_2100s_585", name: "Flood Risk 2100s SSP5-8.5", icon: TrendingUp, color: "#93c5fd",
    source: "tiles", group: "climate_projections", available: false, tileLayerId: "fri_2100s_585", hasValueTiles: false,
    valueEncoding: { type: "numeric", scale: 100, offset: 0, unit: "index 0–1" } },
  // HWM projections
  {
    id: "oef_hwm_2030s_245", name: "Heatwave Mag. 2030s SSP2-4.5", icon: TrendingUp, color: "#b45309",
    source: "tiles", group: "climate_projections", available: false, tileLayerId: "hwm_2030s_245",
    hasValueTiles: true,
  ...
  { id: "oef_hwm_2030s_585", name: "Heatwave Mag. 2030s SSP5-8.5", icon: TrendingUp, color: "#d97706",
    source: "tiles", group: "climate_projections", available: false, tileLayerId: "hwm_2030s_585", hasValueTiles: false,
  ...
  { id: "oef_hwm_2050s_585", name: "Heatwave Mag. 2050s SSP5-8.5", icon: TrendingUp, color: "#f59e0b",
    source: "tiles", group: "climate_projections", available: false, tileLayerId: "hwm_2050s_585", hasValueTiles: false,
    valueEncoding: { type: "numeric", scale: 100, offset: 1003, unit: "°C·days" } },
  {
    id: "oef_hwm_2100s_585", name: "Heatwave Mag. 2100s SSP5-8.5", icon: TrendingUp, color: "#fbbf24",
    source: "tiles", group: "climate_projections", available: false, tileLayerId: "hwm_2100s_585",
    hasValueTiles: true,
  ...
  { id: "rivers", name: "Rivers", icon: Droplets, color: "#06b6d4", source: "geojson", group: "base_layers", available: true, hasValueTiles: false },
  {
    ...
    available: true,
    hasValueTiles: true,
    valueEncoding: { type: "numeric", unit: "priority score" },
  },
  {
    id: "google_solar_municipal_medium",
    name: "Municipal Solar Medium",
    icon: Building2,
    color: "#f59e0b",
    source: "geojson",
    group: "buildings",
  ...
  { id: "sites_schools",     name: "Schools & Education",           icon: GraduationCap, color: "#f59e0b", source: "geojson", group: "sites", available: false, hasValueTiles: true },
  { id: "sites_hospitals",   name: "Hospitals & Health",            icon: Heart,         color: "#ef4444", source: "geojson", group: "sites", available: false, hasValueTiles: true },
  { id: "sites_wetlands",    name: "Wetlands",                      icon: Waves,         color: "#3b82f6", source: "geojson", group: "sites", available: false, hasValueTiles: true },
  { id: "sites_sports",      name: "Sports Grounds & Plazas",       icon: Dumbbell,      color: "#8b5cf6", source: "geojson", group: "sites", available: false, hasValueTiles: true },
  { id: "sites_social",      name: "Community Facilities",          icon: HandHeart,     color: "#ec4899", source: "geojson", group: "sites", available: false, hasValueTiles: true },
  { id: "sites_vacant",      name: "Vacant & Brownfield Land",      icon: MapIcon,       color: "#a16207", source: "geojson", group: "sites", available: false, hasValueTiles: true },
  { id: "sites_flood_zones", name: "Flood Risk Zones (OSM)",        icon: Waves,         color: "#1d4ed8", source: "geojson", group: "sites", available: false, hasValueTiles: true },
  { id: "sites_flood2024",   name: "2024 Flood Extent (Planet/SkySat)", icon: CloudRain, color: "#60a5fa", source: "geojson", group: "sites", available: false, hasValueTiles: true },
  { id: "ref_viirs_lst",     name: "Heat Intensity (VIIRS 375m)",   icon: Flame,         color: "#f97316", source: "tiles",   group: "sites", available: false, tileLayerId: "viirs_i5_day", hasValueTiles: false },
