...
export const LAYER_CONFIGS: LayerConfig[] = [
  ...
  // ── Derived → Risk Analysis (inline GeoJSON — always has values) ─────────────
  { id: "grid_flood",     name: "Flood Risk",     icon: CloudRain, color: "#3b82f6", source: "geojson", group: "analysis",    available: true, hasValueTiles: true, valueEncoding: { type: "numeric", unit: "score 0–1" } },
  { id: "grid_heat",      name: "Heat Risk",      icon: Flame,     color: "#ef4444", source: "geojson", group: "analysis",    available: true, hasValueTiles: true, valueEncoding: { type: "numeric", unit: "score 0–1" } },
  { id: "grid_landslide", name: "Landslide Risk", icon: Mountain,  color: "#a16207", source: "geojson", group: "analysis",    available: true, hasValueTiles: true, valueEncoding: { type: "numeric", unit: "score 0–1" } },
